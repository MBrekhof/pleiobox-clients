...
namespace LocalBox_iOS.Views
{
    public class PincodeInstellenView : UIView
    {
        ...
        public PincodeInstellenView(CGRect frame)
        {
            Frame = frame;
            BackgroundColor = UIColor.White;
            _contentView = new UIView(new CGRect(0, 0, frame.Width, frame.Height));
            ...
            Layer.ShadowPath = UIBezierPath.FromRect(new CGRect(-5, 0, Bounds.Width, Bounds.Height)).CGPath;
        ...
        void AddComponents()
        {
            nfloat y = Frame.Height - 224 - 16;
            _keypad = new Keypad(new CGRect(14, y, 342, 226));
            ...
            _firstPinInput = new PinInput(new CGRect(14, labelPin1.Frame.Bottom + 8f, 342, 62));
            _contentView.Add(_firstPinInput);

            UILabel labelPin2 = new UILabel(new CGRect(14, _firstPinInput.Frame.Bottom + 24, 342, 26));
            ...
            _secondPinInput = new PinInput(new CGRect(14, labelPin2.Frame.Bottom + 8, 342, 62));
